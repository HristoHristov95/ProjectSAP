...
public class Administrator {
	...
	public void AdminMenu()
	{
		...
		while(!choice.equals("0"))
		{
			...
			switch(choice){
			case"1":
				ClientSideInfo.printOut.println("CreateEmployee"); this.operations.createAndUpdateEmployeeOrCustomer();  break;  //funkciq koqto pita ot servera za infoto na employeeto
			case"2":
